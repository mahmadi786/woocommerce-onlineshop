 ...
 * @since 1.0.0
 */
class Restaurantz_Footer_Widgets {
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'restaurantz';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			...
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'restaurantz' ), $i ),
...
// Initialize.
$restaurantz_footer_widgets = new Restaurantz_Footer_Widgets();
