    ...
    <div class="kt-main" role="main">
        <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-1 col-sm-2 col-xs-2 nopadding">
                                <div class="kt-article-date">
                                    ...
                                    <span class="month_year"><?php the_time('d');
                                    ?>
                                    </div>
                            ...
                            <!-- Main Blog Post -->
                                ...
                                <span><?php echo __('by','burger'); ?> <?php echo get_the_author(); ?></span>
                                ...
                                <div class="kt-article-categories">
                                    ...
                                    <?php comments_number( __('No Comments','businesscard'), __('1 Comment','businesscard'),__('% Comment' ,'businesscard')); ?>
                                    </span>
            ...
            <div id="kt-pagination">
                <div class="alignleft"><?php previous_posts_link(__( '&laquo; Newer posts', 'businesscard' )); ?></div>
                <div class="alignright"><?php next_posts_link(__( 'Older posts &raquo;', 'businesscard' )); ?></div>
            </div>
                </div>
                <!-- Sidebar -->
